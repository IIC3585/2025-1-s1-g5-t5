import { useCart } from '../dashboardContext';

export default function ShoppingCartReact() {
  const { 
    cartItems, 
    removeFromCart, 
    updateQuantity, 
  ...
  // Debug logging
  console.log('🛒 ShoppingCartReact rendered with cartItems:', cartItems);
      ...
      <div className="mt-5">
        <div className="alert alert-info border-0 bg-light">
          <div className="d-flex align-items-center">
            ...
            <div>
              <strong>Carrito React:</strong> Este carrito usa React con gestión de estado global mediante Context API para una experiencia de compra fluida.
            </div>
          </div>
        </div>
      </div>
